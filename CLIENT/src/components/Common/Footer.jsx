                                ...
                                <div className="space-y-5">
                                    { recentBlogs.length > 0 ? recentBlogs.map((blog, idx) => (
                                        <div key={ idx } className="flex gap-4 group">
                                            ...
                                            <div>
                                                <h6 className="text-xs font-semibold text-[#885023] mb-1 leading-snug group-hover:text-brand-gold transition-colors heading-font"><NavLink to={ blog.slug ? `/blog-single/${blog.slug}` : "/blog-single" }>{ blog.title }</NavLink></h6>
                                                <p className="text-[10px] text-[#885023]"><i className="fa fa-user mr-1 text-brand-gold"></i> By { blog.author || 'Admin' }</p>
                                            </div>
                                        </div>
                                    )) : (
