                            ...
                            <div className="section-content">
                                <div id="no-more-tables">
                                    <table className="table-bordered  table-condensed cf wt-responsive-table shopping-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td data-title="Code"><img src={new URL('./../../images/cart/pic-1.jpg', import.meta.url).href} alt=""/></td>
                                            ...
                                            <tr>
                                                <td data-title="Code"><img src={new URL('./../../images/cart/pic-2.jpg', import.meta.url).href} alt=""/></td>
